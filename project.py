...
def wish_user():
    ...
    fun_talk("I am Ultron. Tell me What I can do for you.")


def get_command():
    # taking voice as input from the user
...
if __name__ == "__main__":
    # main function calling wish_user and performing queries
    wish_user()
    ...
    # if 1:
        ...
        if 'wikipedia' in query:
            ...
            fun_talk("I am ULTRON, developed by Utkarsh Ranjan, Preet, "
                     "Mayank sharma, Sahil and Manish  as a project in their college.")

        elif 'what you want to do' in query:
            fun_talk("I want to help people to do certain tasks on their voice commands.")
            ...
            email_list = {
                'Mayank': 'mayanksharmag02@gmail.com',
                'Rishabh': 'rishabhran123@gmail.com',
                'Utkarsh': 'something@something.com',
            ...
            if 'no' in cmd:
                ...
                # todo: add some lines to exit other applications before shutdown
            ...
            if 'no' in cmd:
                ...
                # todo: add some lines to exit other applications before restart
        ...
        elif 'what' in query or 'who' in query:  # or 'where' in query:   # GK type qus can be asked
                    ...
                    world_cases()
                            ...
                            def country_cases():
                                try:
                                    ...
                                    new_data = c_data.find('div', class_='content-inner').findAll('div',
                                                                                                  id='maincounter-wrap')
                                    # print(new_data)
                            ...
                            try:
                                ...
                                auth = get_command()
                                poem = poetpy.get_poetry('author', auth,
                                                         'title,linecount')  # to get title and linecount of poem
                                poems = poetpy.get_poetry('author', auth, 'lines')  # to get lines of poem
